...
\paragraph{•}
\begin{minipage}{\linewidth}
\lstinputlisting[caption=Reading data from the SAMPA buffers.,firstline=28,lastline=54,label=lst:read-buffers]{codelistings/sampa2.cpp}
\end{minipage}
...
\begin{minipage}{\linewidth}
\lstinputlisting[caption=Difference between \textit{standardSink} and \textit{incrementingOccupancySink} functions.,firstline=1,lastline=17,label=lst:sink-diff1]{codelistings/dg-diff.cpp}
\end{minipage}

\paragraph{•}
\begin{minipage}{\linewidth}
\lstinputlisting[caption=Difference between \textit{standardSink} and \textit{alternatingOccupancySink} functions.,firstline=20,lastline=32,label=lst:sink-diff2]{codelistings/dg-diff.cpp}
\end{minipage}
