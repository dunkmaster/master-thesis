...
\paragraph{•}%Change according to removing the header files. maybe still keep the channel header? Maybe a figure of it!
...
\begin{minipage}{\linewidth}
\lstinputlisting[caption=Receive samples.,firstline=26,lastline=57,label=lst:receive-channel]{codelistings/channel.cpp}
\end{minipage}
...
\lstinputlisting[caption=Data generator SystemC thread.,firstline=20,lastline=32,label=lst:diff2]{codelistings/dg-diff.cpp}
\end{minipage}
...
%Express that the mapping was not used, and the simulation doesn't care about that.
