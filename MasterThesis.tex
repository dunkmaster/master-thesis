...
The module needs to be able to continuously send samples, based on what is desired for a specific simulation.
...
\paragraph{•}
The simulation needs two different data types, these has been briefly shown in the previous code listings.
