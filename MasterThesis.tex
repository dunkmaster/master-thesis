...
The difference it makes compared to triggered mode can be seen in figure~\ref{fig:cont} and \ref{fig:trig}.
...
Some channels may be full while others are empty, and some may have 40"\%", but on average there is 30"\%", which means 306 samples out of 1022 every time frame.
